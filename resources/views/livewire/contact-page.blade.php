            ...
            <div class="col-lg-7">
                ...
                <div class="p-4 bg-white shadow rounded border border-warning">
                    ...
                    <ul class="list-unstyled small">
                        <li class="mb-2">
                            <a href="{{ route('homepage') }}" class="text-dark text-decoration-none">
                                <i class="fa fa-home me-2 text-warning"></i>Home
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('aboutpage') }}" class="text-dark text-decoration-none">
                                <i class="fa fa-info-circle me-2 text-warning"></i>About Us
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('contactpage') }}" class="text-dark text-decoration-none">
                                <i class="fa fa-envelope me-2 text-warning"></i>Contact
                            </a>
                        </li>
                        <li class="mb-2">
                            <a href="{{ route('homepage') }}#our-best-machines" class="text-dark text-decoration-none">
                        ...
                        <li class="mb-2">
                            <a href="{{ route('homepage') }}#testimonials-area" class="text-dark text-decoration-none">
                                <i class="fa fa-star me-2 text-warning"></i>Testimonials
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('homepage') }}#other-issue-area" class="text-dark text-decoration-none">
                                <i class="fa fa-question-circle me-2 text-warning"></i>Other Issues
                            </a>
                        </li>
                    </ul>
                </div>
