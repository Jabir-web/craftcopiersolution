...
<div>
    ...
    <h4 class="fw-bold mb-4 text-warning">Quick Links</h4>
    <ul class="list-unstyled small mb-0">
        <li class="mb-3">
            <a href="{{ route('homepage') }}" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-home text-warning"></i> Home
            </a>
        </li>
        <li class="mb-3">
            <a href="{{ route('aboutpage') }}" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-info-circle text-warning"></i> About Us
            </a>
        </li>
        <li class="mb-3">
            <a href="{{ route('contactpage') }}" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-envelope text-warning"></i> Contact
            </a>
        </li>
        <li class="mb-3">
            <a href="{{ route('homepage') }}#our-best-machines" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-print text-warning"></i> Machines
            </a>
        </li>
        <li class="mb-3">
            <a href="{{ route('homepage') }}#blog-list-area" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-list text-warning"></i> Blogs
            </a>
        </li>
        <li class="mb-3">
            <a href="{{ route('homepage') }}#testimonials-area" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-star text-warning"></i> Testimonials
            </a>
        </li>
        <li>
            <a href="{{ route('homepage') }}#other-issue-area" class="text-dark text-decoration-none d-flex align-items-center gap-2">
                <i class="fa fa-question-circle text-warning"></i> Other Issues
            </a>
        </li>
    </ul>
</div>
