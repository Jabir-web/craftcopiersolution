            ...
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 banner-left">
                        <h6 class="text-white d-block d-sm-none">Your one-stop shop for printer sales, repairs, and maintenance.</h6>
                        <h1 class="text-white">RELIABLE cccccccccccccccccccccc PRINTER SOLUTIONS</h1>
                        <p class="text-white">
                        ...
                        <a href="{{ route('contactpage') }}" wire:navigate class="primary-btn text-uppercase">Get a Free Consultation.</a>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="single-destination relative">
                            <div class="thumb relative">
                                <div class="overlay overlay-bg"></div>
                                <img class="img-fluid" src="{{ asset('front/img/web/kyocera-machine.jpg') }}" alt="">
                            </div>
                            <div class="desc">
