<div>
	...
	<section class="post-content-area">
		<div class="container">
				...
				<div class="col-lg-8 posts-list">
					@if ($blog)
						...
						<article class="single-blog-container p-4 shadow-lg rounded bg-white"
							...
							<header>
								<h1 class="mb-3 text-primary" style="font-weight: 800; font-size: 1.75rem; color: #ffffff !important; line-height: 1.3; background-color: #02d602; border-radius: 12px; padding: 10px;">
									{{ $blog->title }}
								</h1>
							</header>
							...
							<figure class="mb-4">
								<img loading="lazy" src="{{ url('storage/' . $blog->img) }}" alt="{{ $blog->title }} - Blog Image"
									class="img-fluid rounded mb-4" style="max-height: 100%; object-fit: cover; width: 100%; height: auto;">
							</figure>
         ...
         style="line-height: 1.8; color: #38414e; font-size: 1.1rem; 
