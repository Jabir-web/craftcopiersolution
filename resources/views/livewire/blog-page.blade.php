...
@section('meta_description', $blog ? Str::limit(strip_tags($blog->description), 150) : 'Read expert printer and copier
    tips, news, and guides from Craft Copier Solution.')
@section('meta_keywords', $blog ? $blog->category . ', printer blog, copier tips, printer repair Karachi, office
    productivity, copier rental, printer maintenance, Craft Copier Solution blog' : 'printer blog, copier tips, printer
    repair Karachi, office productivity, copier rental, printer maintenance, Craft Copier Solution blog')
@section('og_title', $blog ? $blog->title : 'Blog | Craft Copier Solution')
@section('og_description', $blog ? Str::limit(strip_tags($blog->description), 150) : 'Read expert printer and copier
    tips, news, and guides from Craft Copier Solution.')
...
@section('twitter_description', $blog ? Str::limit(strip_tags($blog->description), 150) : 'Read expert printer and
    copier tips, news, and guides from Craft Copier Solution.')
                ...
                <div class="about-content col-lg-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center bg-transparent p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('homepage') }}" class="text-white">Home</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ url('/blog') }}" class="text-white">Blog</a></li>
                            @if ($blog)
                                <li class="breadcrumb-item active text-white" aria-current="page">{{ $blog->title }}
                                </li>
                            @endif
                        </ol>
                    </nav>
                ...
                <div class="col-lg-8 posts-list">
                    @if ($blog)
                        <article class="single-blog-container p-4 shadow-lg rounded bg-white"
                            style="border: 1px solid #e2e8f0; font-family: 'Poppins', sans-serif;" itemscope
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-3">
                                    <a href="{{ route('homepage') }}" class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-primary text-white me-3"><i
                                ...
                                <li class="mb-3">
                                    <a href="{{ route('aboutpage') }}" class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-success text-white me-3"><i
                                ...
                                <li class="mb-3">
                                    <a href="{{ route('contactpage') }}"
                                        class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-danger text-white me-3"><i
                                ...
                                <li class="mb-3">
                                    <a href="{{ route('homepage') }}#our-best-machines"
                                        class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-warning text-white me-3"><i
                                ...
                                <li class="mb-3">
                                    <a href="{{ route('homepage') }}#blog-list-area"
                                        class="d-flex align-items-center quick-link blogs-link">
                                        <span class="quick-link-icon bg-info text-white me-3"><i
                                                class="fa fa-list"></i></span>
                                        <span class="quick-link-text blogs-link-text">
                                            <span
                                                style="font-weight:700; color:#0F172A; letter-spacing:1px;">Blogs</span>
                                            <span
                                                style="font-size:0.92em; color:#02d602; font-weight:500; margin-left:6px;"></span>
                                        </span>
                                    </a>
                                </li>
                                <li class="mb-3">
                                    <a href="{{ route('homepage') }}#testimonials-area"
                                        class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-secondary text-white me-3"><i
                                ...
                                <li>
                                    <a href="{{ route('homepage') }}#other-issue-area"
                                        class="d-flex align-items-center quick-link">
                                        <span class="quick-link-icon bg-dark text-white me-3"><i
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-center gap-3 mb-3 ">
                                <a href="https://www.facebook.com/craftcopiersolutions" target="_blank"
                                    rel="noopener noreferrer" class="text-primary fs-5">
                                    <i class="fa fa-facebook"></i>
                                </a>
                                ...
                                <a href="https://www.instagram.com/craftcopiersolution/" target="_blank"
                                    rel="noopener noreferrer" class="text-danger fs-5 mx-2">
                        ...
                        <div class="single-sidebar-widget popular-post-widget mb-4 p-4 bg-white shadow rounded">
                            ...
                            <div class="popular-post-list">
                                @foreach ($blogs->take(5) as $popular)
                                    <a href="{{ route('blogpage', ['title' => $popular->title]) }}"
                                        class="blog-link d-flex align-items-center mb-3"
                                        style="text-decoration: none;">
                                        <img src="{{ url('storage/' . $popular->img) }}" alt="{{ $popular->title }}"
                                            style="width: 60px; height: 60px; object-fit: cover; border-radius: 8px; margin-right: 12px;">
                                        <div>
                                            <h5 class="mb-1" style="font-size: 1rem; color: #0F172A;">
                                                {{ $popular->title }}</h5>
                                            <small
                                                class="text-muted">{{ $popular->created_at->format('M d, Y') }}</small>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
